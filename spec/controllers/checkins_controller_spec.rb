  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved checkin as @checkin" do
        ...
        post :create, {:checkin => { "user_id" => "invalid value" }}, valid_session
        assigns(:checkin).should be_a_new(Checkin)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested checkin" do
        ...
        Checkin.any_instance.should_receive(:update).with({ "user_id" => "1" })
        put :update, {:id => checkin.to_param, :checkin => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the checkin as @checkin" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Checkin.any_instance.stub(:save).and_return(false)
        put :update, {:id => checkin.to_param, :checkin => { "user_id" => "invalid value" }}, valid_session
        assigns(:checkin).should eq(checkin)
      end
